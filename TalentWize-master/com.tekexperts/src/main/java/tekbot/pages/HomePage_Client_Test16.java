...
public class HomePage_Client_Test16 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Test 6 Manager.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Test 6 Manager. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Test 6 Manager!')]");
	...
	public HomePage_Client_Test16(WebDriver driver) {
		super(driver);
