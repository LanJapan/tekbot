...
public class HomePage_Client_Test17 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Dev 4 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Dev 4 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Dev 4 Staff!')]");
	...
	public HomePage_Client_Test17(WebDriver driver) {
		super(driver);
