...
public class HomePage_Client_Test6 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you UAT 2 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning UAT 2 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello UAT 2 Staff!')]");
	...
	public HomePage_Client_Test6(WebDriver driver) {
		super(driver);
