...
public class HomePage_Client_Test1 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Test 1 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Test 1 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Test 1 Staff!')]");
	...
	By txtFinishLunch=By.xpath("//p[contains(.,'Don’t go sleepy on me now Test 1 Staff ;)')]");
	...
	By txtProject=By.xpath("//p[contains(.,'Duty calls Test 1 Staff.')]");
	By btnFinishProject=By.xpath("//button[contains(.,'Finish Project (#project)')]");
	By txtFinishProject=By.xpath("//p[contains(.,'Welcome back Test 1 Staff.')]");
	...
	By txtNesting=By.xpath("//p[contains(.,'Duty calls Test 1 Staff.')]");
	By btnFinishNesting=By.xpath("//button[contains(.,'Finish Nesting (#nesting)')]");
	By txtFinishNesting=By.xpath("//p[contains(.,'Welcome back Test 1 Staff.')]");
	...
	public HomePage_Client_Test1(WebDriver driver) {
		super(driver);
	       ...
	       String parentWindow = driver.getWindowHandle();
	        ...
	        for (String windowHandle : handles) {
	            if (!windowHandle.equals(parentWindow)) {
	                ...
	                typeEmail(PropertyManager.BOTTest1);
	               // clickButtonNext();
	                try {
	                ...
	                typePassword(PropertyManager.BOTPASSWORD_Test1);
	                try {
