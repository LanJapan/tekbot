...
public class HomePage_Client_Test7 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Dev1 Azure Manager.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Dev1 Azure Manager. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Dev1 Azure Manager!')]");
	...
	public HomePage_Client_Test7(WebDriver driver) {
		super(driver);
