...
public class HomePage_Client_Test3 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Dev 1 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Dev 1 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Dev 1 Staff!')]");
	...
	public HomePage_Client_Test3(WebDriver driver) {
		super(driver);
	       ...
	       String parentWindow = driver.getWindowHandle();
	        ...
	        for (String windowHandle : handles) {
	            if (!windowHandle.equals(parentWindow)) {
	                ...
	                typeEmail(PropertyManager.BOTDev1);
	               // clickButtonNext();
	                try {
	                ...
	                typePassword(PropertyManager.BOTPASSWORD_Dev1);
	                try {
