...
public class HomePage_Client_Test20 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Dev 3 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Dev 3 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Dev 3 Staff!')]");
	...
	public HomePage_Client_Test20(WebDriver driver) {
		super(driver);
