...
public class HomePage_Client_Test19 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Dev 6 Manager.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Dev 6 Manager. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Dev 6 Manager!')]");
	...
	public HomePage_Client_Test19(WebDriver driver) {
		super(driver);
