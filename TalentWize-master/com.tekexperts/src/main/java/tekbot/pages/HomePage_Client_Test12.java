...
public class HomePage_Client_Test12 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Test 2 Azure Manager.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Test 2 Azure Manager. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Test 2 Azure Manager!')]");
	...
	public HomePage_Client_Test12(WebDriver driver) {
		super(driver);
