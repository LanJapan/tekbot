...
public class HomePage_Client_Test5 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you UAT 1 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning UAT 1 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello UAT 1 Staff!')]");
	...
	public HomePage_Client_Test5(WebDriver driver) {
		super(driver);
