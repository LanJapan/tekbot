...
public class HomePage_Client_Test14 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Test  4 Staff.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Test  4 Staff. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Test  4 Staff!')]");
	...
	public HomePage_Client_Test14(WebDriver driver) {
		super(driver);
