...
public class HomePage_Client_Test15 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Test 5 Manager.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Test 5 Manager. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Test 5 Manager!')]");
	...
	public HomePage_Client_Test15(WebDriver driver) {
		super(driver);
