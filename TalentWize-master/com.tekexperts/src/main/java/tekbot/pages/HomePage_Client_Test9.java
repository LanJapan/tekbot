...
public class HomePage_Client_Test9 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Test 1 Azure Manager.')]");
	...
	By txtGoodMorning = By.xpath("//p[contains(.,'Good morning Test 1 Azure Manager. Let’s start your day!')]");
	By btnImin = By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello = By.xpath("//p[contains(.,'Hello Test 1 Azure Manager!')]");
	...
	public HomePage_Client_Test9(WebDriver driver) {
		super(driver);
	...
	public String openNewTabAndGetCode(WebDriver driver, String email, String password) {
		...
		for (String windowHandle : handles) {
			if (!windowHandle.equals(parentWindow)) {
				...
				clickButtonYes();
				try {
					waitForElementPresent(25, txtCode);
				} catch (InterruptedException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
