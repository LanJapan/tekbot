...
public class HomePage_Client_Test18 extends WebActions {
	...
	By txtNiceMeetingYou = By.xpath("//p[contains(.,'Nice meeting you Dev 5 Manager.')]");
	...
	By txtGoodMorning=By.xpath("//p[contains(.,'Good morning Dev 5 Manager. Let’s start your day!')]");
	By btnImin=By.xpath("(//button[contains(@type,'button')])[3]");
	By txtHello=By.xpath("//p[contains(.,'Hello Dev 5 Manager!')]");
	...
	public HomePage_Client_Test18(WebDriver driver) {
		super(driver);
