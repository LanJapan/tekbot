...
public class Test_ChatBot_Activities_Button_Button extends TestManager {
	...
	public void Help() throws InterruptedException {
		...
		@Test(priority = 7)
		public void TT_6819() throws InterruptedException {
		...
		@Test(priority = 8)
				public void TT_6822() throws InterruptedException {
				...
				@Test(priority = 9)
				public void TT_6825() throws InterruptedException {
					homePage.waitForPageLoaded();
					TestLogger.info("Scroll to Break button");
					homePage.scrolltoActivityCategory();
					TestLogger.info("Click Meeting (#meeting) button");
					...
					homePage.waitForPageLoaded();
					homePage.scrolltoBtnLunch();
					TestLogger.info("Click Lunch button");
					homePage.clickButtonLunch();
					homePage.waitForPageLoaded();
					homePage.scrollToBottomPage();
					if (homePage.isTxtCommandLunchDisplayed()== true) {
					...
					homePage.waitForPageLoaded();
					homePage.scrolltoBtnLunch();
					TestLogger.info("Click Meeting button");
					homePage.clickButtonMeeting();
					homePage.scrollToBottomPage();
		...
		@Test(priority = 10)
			public void TT_6828() throws InterruptedException {
					homePage.waitForPageLoaded();
					TestLogger.info("User type random thing to the bot.");
				...
				@Test(priority = 11)
				public void TT_6831() throws InterruptedException {
					TestLogger.info("Scroll to Break button");
					homePage.scrolltoActivityCategory();
					...
					homePage.scrolltoBtnLunch();
					homePage.waitForPageLoaded();
					TestLogger.info("Click 1 On 1 button");
					homePage.clickButton1on1();
					homePage.waitForPageLoaded();
					homePage.scrollToBottomPage();
				...
				@Test(priority = 12)
				public void TT_6834() throws InterruptedException {
					homePage.waitForPageLoaded();
					TestLogger.info("User type random thing to the bot.");
					homePage.typeMessage("#activity");
					homePage.waitForPageLoaded();
					TestLogger.info("Click Project button");
				...
				@Test(priority = 13)
				public void TT_6837() throws InterruptedException {
					TestLogger.info("Scroll to Break button");
					homePage.scrolltoActivityCategory();
					TestLogger.info("Click Nesting button");
				...
				@Test(priority = 14)
				public void TT_6612() throws InterruptedException {
					TestLogger.info("Type random stuffs");
					homePage.typeMessage("help");
					//=====================================
					if (homePage.isLblHelpDisplayed()== true) {
						setStatusTest("PASS", "Help title is displayed");
				...
				@Test(priority = 15)
				public void TT_6622() throws InterruptedException {
					TestLogger.info("Type random stuffs");
					homePage.typeMessage("help");
					//=====================================
					if (homePage.isLblHelpDisplayed()== true) {
