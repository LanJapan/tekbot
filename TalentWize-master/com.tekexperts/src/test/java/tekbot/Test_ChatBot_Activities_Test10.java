...
public class Test_ChatBot_Activities_Test10 extends TestManager {
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTTESTAD2, PropertyManager.BOTPASSWORD_TESTAD2);
