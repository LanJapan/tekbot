...
import tekbot.pages.HomePage_Client_Test16;

public class Test_ChatBot_Activities_Test16 extends TestManager {

	HomePage_Client_Test16 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test16(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTTEST6, PropertyManager.BOTPASSWORD_TEST3);
