...
import tekbot.pages.HomePage_Client_Test19;

public class Test_ChatBot_Activities_Test19 extends TestManager {

	HomePage_Client_Test19 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test19(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTDEV6, PropertyManager.BOTPASSWORD_TEST3);
