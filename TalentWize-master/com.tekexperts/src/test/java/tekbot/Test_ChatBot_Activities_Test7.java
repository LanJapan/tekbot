...
import tekbot.pages.HomePage_Client_Test7;

public class Test_ChatBot_Activities_Test7 extends TestManager {

	HomePage_Client_Test7 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test7(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTDEVAD1, PropertyManager.BOTPASSWORD_DEVAD1);
