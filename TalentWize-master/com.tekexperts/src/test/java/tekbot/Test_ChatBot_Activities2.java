...
public class Test_ChatBot_Activities2 extends TestManager {
	...
	@Test(priority = 4)
	public void TT_6623() throws InterruptedException {
		homePage.waitForPageLoaded();
	...
	@Test(priority = 5)
	public void TT_6611() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type: #imout");
		homePage.typeMessage("#imout");
		if (homePage.isLblClockingOutDisplayed() == true) {
	...
	@Test(priority = 6)
	public void TT_6675() throws InterruptedException {
		homePage.waitForPageLoaded();
	...
	@Test(priority = 7)
	public void TT_6677() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 8)
	public void TT_6679() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 9)
	public void TT_6681() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 10)
	public void TT_6796() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 11)
	public void TT_6798() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 12)
	public void TT_6800() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 13)
	public void TT_6674() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type: #imout");
		homePage.typeMessage("#imout");
		homePage.waitForPageLoaded();
