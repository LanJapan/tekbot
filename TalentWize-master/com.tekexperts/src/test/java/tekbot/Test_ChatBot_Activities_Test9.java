...
import tekbot.pages.HomePage_Client_Test9;

public class Test_ChatBot_Activities_Test9 extends TestManager {

	HomePage_Client_Test9 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test9(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTTESTAD1, PropertyManager.BOTPASSWORD_TESTAD1);
