...
public class Test_ChatBot_Activities5 extends TestManager {
	...
	@Test(priority = 5)
	public void TT_6818() throws InterruptedException {
		homePage.waitForPageLoaded();
	...
	@Test(priority = 7)
	public void TT_6821() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		TestLogger.info("Click Activity (#activity) button");
...
/*		TestLogger.info("Scroll to bottom page");
	...
	@Test(priority = 8)
	public void TT_6824() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		TestLogger.info("Click Activity (#activity) button");
	...
	@Test(priority = 9)
	public void TT_6827() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		TestLogger.info("Click Activity (#activity) button");
	...
	@Test(priority = 10)
	public void TT_6830() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		TestLogger.info("Click Activity (#activity) button");
	...
	@Test(priority = 11)
	public void TT_6833() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
	...
	@Test(priority = 12)
	public void TT_6836() throws InterruptedException {
		homePage.waitForPageLoaded();
		TestLogger.info("User type random thing to the bot.");
		homePage.typeMessage("help");
		homePage.waitForPageLoaded();
