...
import tekbot.pages.HomePage_Client_Test11;

public class Test_ChatBot_Activities_Test11 extends TestManager {

	HomePage_Client_Test11 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test11(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTUAT2AD, PropertyManager.BOTPASSWORD_UAT2AD);
