...
import tekbot.pages.HomePage_Client_Test18;

public class Test_ChatBot_Activities_Test18 extends TestManager {

	HomePage_Client_Test18 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test18(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTDEV5, PropertyManager.BOTPASSWORD_TEST3);
