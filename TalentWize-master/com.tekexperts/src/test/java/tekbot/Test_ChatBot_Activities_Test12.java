...
import tekbot.pages.HomePage_Client_Test12;

public class Test_ChatBot_Activities_Test12 extends TestManager {

	HomePage_Client_Test12 homePage;
	WebDriver driver;
	...
	public void KhoiTaoCacNguonTaiNguyen() {
		...
		homePage = new HomePage_Client_Test12(driver);
	...
	public void TT_6135() throws InterruptedException {
		...
		String code=homePage.openNewTabAndGetCode(driver, PropertyManager.BOTTEST2AD, PropertyManager.BOTPASSWORD_TEST2AD);
