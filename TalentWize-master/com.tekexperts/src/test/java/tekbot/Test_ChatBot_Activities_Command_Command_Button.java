...
public class Test_ChatBot_Activities_Command_Command_Button extends TestManager {
	...
	public void ImIn() throws InterruptedException {
		...
		@Test(priority = 5)
		public void TT_6820() throws InterruptedException {
			homePage.waitForPageLoaded();
			TestLogger.info("Type command: #activity");
			...
			homePage.waitForPageLoaded();
			TestLogger.info("Click on Lunch button");
		...
		@Test(priority = 6)
		public void TT_6823() throws InterruptedException {
			homePage.waitForPageLoaded();
			TestLogger.info("Type command: #break");
			homePage.typeMessage("#break");
			...
			homePage.waitForPageLoaded();
			TestLogger.info("Click on Break button");
		...
		@Test(priority = 7)
		public void TT_6826() throws InterruptedException {
			homePage.waitForPageLoaded();
			TestLogger.info("Type command: #meeting");
			homePage.typeMessage("#meeting");
			//=====================================
	...
	@Test(priority = 8)
	public void TT_6829() throws InterruptedException {
			homePage.waitForPageLoaded();
		...
		@Test(priority = 9)
		public void TT_6832() throws InterruptedException {
			homePage.waitForPageLoaded();
		...
		@Test(priority = 10)
		public void TT_6835() throws InterruptedException {
			homePage.waitForPageLoaded();
		...
		@Test(priority = 11)
		public void TT_6838() throws InterruptedException {
			homePage.waitForPageLoaded();
		...
		@Test(priority = 12)
		public void TT_6899() throws InterruptedException {
			homePage.waitForPageLoaded();
			TestLogger.info("Type command: #project");
			homePage.typeMessage("#project");
			//=====================================
			...
			//====================================
			TestLogger.info("Click on Back to Activity");
			homePage.clickBtnBackToActivityCategory();
			if (homePage.isLblFinishYourActivityFirst_ProjectDisplayed()== true) {
				setStatusTest("PASS", "Finish Your Activity First title is displayed");
			} else {
				setStatusTest("FAIL", "Finish Your Activity First title  is NOT displayed");
		...
		@Test(priority = 13)
		public void TT_6902() throws InterruptedException {
			homePage.waitForPageLoaded();
			TestLogger.info("Type command: #yes");
			...
			{
				setStatusTest("PASS", "Time to get some deserved rest! See you tomorrow {nickname} is displayed");
			}
			else
			{
				setStatusTest("PASS", "Time to get some deserved rest! See you tomorrow {nickname} is NOT displayed");
			}
	}
